...
import { DEFAULT_IMAGE_URL, variables } from '@gsf/admin/app/shared/consts';
import { OverlayTriggerDirective } from '@gsf/admin/app/shared/directives';
import { RatioEnum } from '@gsf/admin/app/shared/enums';
import {
  CanvasFacadeService,
...
import { Variable, VariableType } from '@gsf/admin/app/shared/types';
import {
  ButtonDirective,
  ICON_16x9,
  ICON_1x2,
